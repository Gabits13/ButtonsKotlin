...
fun BotonNormal2(){
    Button(onClick = { /*TODO*/ }, colors = ButtonDefaults.buttonColors(
        ...
        Text(text = "Meu Botão 2", fontSize = 30.sp)
    }
}
...
fun BotonTexto(){
    TextButton(onClick = { /*TODO*/ }) {
        Text(text = "Meu Botão 3", fontSize = 30.sp)
...
fun BotonOutline(){
    OutlinedButton(onClick = { /*TODO*/ }, border = BorderStroke(3.dp, Color.Blue)) {
        Text(text = "Meu Botão 4", fontSize = 30.sp)
...
fun BotonIcono(){
    IconButton(onClick = { /*TODO*/ }) {
        Icon(
            ...
            tint = Color.Red,
            modifier = Modifier.size(50.dp) //possivel erro
